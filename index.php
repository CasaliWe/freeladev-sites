...
<head>
    ...
    <!--FAV ICON-->
    <link rel="icon" href="./img/favicon/favicon-admin.png">
...
<body>
    ...
    <div id="all-content" class="d-none">
                            ...
                            <div id="carousel" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                    ...
                                    <div class="carousel-item active _carousel-item1">
                                        ...
                                        <h5 class="d-none d-lg-block">Landing pages | Sites empresariais | Mini sites | Portfólio</h5>
            ...
            <div class="offset-md-1 col-md-10 offset-xl-2 col-xl-8 text-center">
                ...
                <div class="row pt-3">
                    ...
                    <div data-aos="fade-down" class="col-12 col-lg-6">
                        <form id="form-contato" action="admin/api/enviar-email.php" method="post">
       ...
       <!--FOOTER-->
       <footer id="footer">
              <span style="margin-right: 6px;">Copyright © 2024</span> <span style="color: orangered;">Freeladev</span>
       </footer>
       <!--FOOTER-->
